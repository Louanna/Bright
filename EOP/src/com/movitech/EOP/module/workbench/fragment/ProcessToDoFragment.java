...
public class ProcessToDoFragment extends BaseFragment implements
    ...
    protected void initDatas() {
        ...
        adapter.setIsDo(ProcessAdapter.TODO);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent = new Intent(ProcessToDoFragment.this.getActivity(), WebViewActivity.class);
                ...
                ProcessToDoFragment.this.getActivity().startActivity(intent);
            }
        });
   ...
   //获取待办数据
    private void getBpiItemInfo(int page){
        ...
        OAManager.getOAORERPList(ProcessAdapter.TODO, systemCode, page,"",new StringCallback() {
            @Override
                    ...
                    if(baseModel.getOk()){
                        ...
                        if(null != process){
                            ...
                            if(null != processNumListener && null!=object && null!=(new JSONObject(object)).getString("total")){
                                ...
                                CommConstants.OATODOTOTAL = (new JSONObject(object)).getString("total");
