...
public class HttpManager {
    ...
    public static void downloadFile(String fileUrl, String cookies, FileCallBack fileCallBack) {
        OkHttpUtils
                .getWithToken()
    ...
    //上传单个文件
    public static void uploadFile(String url, Map<String, String> params, File file, String fileKey, ListCallback callback) {
        OkHttpUtils.postWithToken()
                .addFile(fileKey, file.getName(), file)
                .url(url)
                .params(params)
