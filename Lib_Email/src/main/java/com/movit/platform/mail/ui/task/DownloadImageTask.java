...
import com.movit.platform.mail.provider.AttachmentProvider.AttachmentProviderColumns;
...
public class DownloadImageTask extends AsyncTask<String, Void, String> {
    ...
    private String writeFileToStorage(String fileName, InputStream in) throws IOException {
        ...
        File directory = new File(MailboxController.getAttachmentDefaultPath());
