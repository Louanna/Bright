...
import com.movit.platform.mail.bean.Account.Expunge;
...
import com.movit.platform.mail.controller.MailboxController.Intents;
import com.movit.platform.mail.mailstore.LocalFolder;
import com.movit.platform.mail.mailstore.LocalFolder.MoreMessages;
import com.movit.platform.mail.mailstore.LocalMessage;
import com.movit.platform.mail.mailstore.LocalStore;
import com.movit.platform.mail.mailstore.LocalStore.PendingCommand;
import com.movit.platform.mail.mailstore.MessageRemovalListener;
import com.movit.platform.mail.mailstore.UnavailableStorageException;
import com.movit.platform.mail.notification.NotificationController;
import com.movit.platform.mail.preferences.Preferences;
import com.movit.platform.mail.provider.EmailProvider;
import com.movit.platform.mail.provider.EmailProvider.StatsColumns;
import com.movit.platform.mail.search.ConditionsTreeNode;
import com.movit.platform.mail.search.LocalSearch;
import com.movit.platform.mail.search.SearchAccount;
...
import static com.movit.platform.mail.controller.MailboxEntry.saveNeedRefreshFolder;
...
public class MessageController implements Runnable {
    ...
    private static final String PENDING_COMMAND_MOVE_OR_COPY = "com.fsck.k9.MessageController.moveOrCopy";
    private static final String PENDING_COMMAND_MOVE_OR_COPY_BULK = "com.fsck.k9.MessageController.moveOrCopyBulk";
    private static final String PENDING_COMMAND_MOVE_OR_COPY_BULK_NEW = "com.fsck.k9.MessageController.moveOrCopyBulkNew";
    private static final String PENDING_COMMAND_EMPTY_TRASH = "com.fsck.k9.MessageController.emptyTrash";
    private static final String PENDING_COMMAND_SET_FLAG_BULK = "com.fsck.k9.MessageController.setFlagBulk";
    private static final String PENDING_COMMAND_SET_FLAG = "com.fsck.k9.MessageController.setFlag";
    private static final String PENDING_COMMAND_APPEND = "com.fsck.k9.MessageController.append";
    private static final String PENDING_COMMAND_MARK_ALL_AS_READ = "com.fsck.k9.MessageController.markAllAsRead";
    private static final String PENDING_COMMAND_EXPUNGE = "com.fsck.k9.MessageController.expunge";
    ...
    @VisibleForTesting
    MessageController(Context context, NotificationController notificationController) {
    ...
    public synchronized static MessageController getInstance(Context context) {
        if (inst == null) {
            Context appContext = context.getApplicationContext();
            NotificationController notificationController = NotificationController.newInstance(appContext);
            inst = new MessageController(appContext, notificationController);
        }
        return inst;
    }
    ...
    public void run() {
        ...
        while (!stopped) {
            ...
            try {
                        ...
                        new Thread() {
                            ...
                            public void run() {
                                try {
                                    ...
                                    System.out.println("interrupted while putting a pending command for"
                ...
                System.out.println("Error running command '" + commandDescription + "'");
            }
            mBusy = false;
        }
    }
    ...
    public void listFoldersSynchronous(final Account account, final boolean refreshRemote, final MessagingListener listener) {
        ...
        if (!account.isAvailable(context)) {
            System.out.println("not listing folders of unavailable account");
        } else {
            try {
    ...
    void refreshRemoteSynchronous(final Account account, final MessagingListener listener) {
        ...
        try {
            ...
            for (Folder remoteFolder : remoteFolders) {
                ...
                EmailBoxListActivity.folderUnReadNum.put(remoteFolder.getName(),remoteFolder.getUnreadMessageCount());
            ...
            for (Folder localFolder : localFolders) {
                ...
                if (MailboxController.FOLDER_NONE.equals(localFolderName)) {
    ...
    public void searchRemoteMessagesSynchronous(final String acctUuid, final String folderName, final String query,
        ...
        try {
            ...
            if (Thread.currentThread().isInterrupted()) {
                System.out.println("Caught exception on aborted remote search; safe to ignore.");
            } else {
                System.out.println("Could not complete remote search");
                if (listener != null) {
        ...
        threadPool.execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    System.out.println("Exception in loadSearchResults: ");
                    addErrorMessage(account, null, e);
                } finally {
                    if (listener != null) {
    ...
    void synchronizeMailboxSynchronous(final Account account, final String folder, final MessagingListener listener,
        ...
        try {
            ...
            intent.putExtra("unread", remoteFolder.getUnreadMessageCount());
            context.sendBroadcast(intent);

            int visibleLimit = localFolder.getVisibleLimit();
            if (visibleLimit < 0) {
                visibleLimit = MailboxController.DEFAULT_VISIBLE_LIMIT;
            }
            ...
            System.out.println("synchronizeMailboxError");
            ...
            if (tLocalFolder != null) {
                try {
                    ...
                    System.out.println("Could not set last checked on folder " + account.getDescription() + ":" +
            ...
            addErrorMessage(account, null, e);
            System.out.println("Failed synchronizing folder " + account.getDescription() + ":" + folder + " @ " + new Date());
    ...
    private int downloadMessages(final Account account, final Folder remoteFolder,
        ...
        if (earliestDate != null) {
            System.out.println("Only syncing messages after " + earliestDate);
        }
        ...
        try {
            ...
            System.out.println("Unable to getUnreadMessageCount for account: " + account);
        }
                ...
                new MessageRetrievalListener<T>() {
                    ...
                    public void messageFinished(T message, int number, int ofTotal) {
                        try {
                            ...
                            System.out.println("Error while storing downloaded message.");
                            addErrorMessage(account, null, e);
                        }
                    }
                ...
                fp, new MessageRetrievalListener<T>() {
                    ...
                    public void messageFinished(final T message, int number, int ofTotal) {
                        try {
                            ...
                            addErrorMessage(account, null, me);
                            System.out.println("SYNC: fetch small messages error");
                        }
                    }
    ...
    private boolean syncFlags(LocalMessage localMessage, Message remoteMessage) throws MessagingException {
        ...
        if (remoteMessage.isSet(Flag.DELETED)) {
            ...
            for (Flag flag : MessageController.SYNC_FLAGS) {
        ...
        putBackground("processPendingCommands", null, new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    System.out.println("Failed to process pending command because storage is not available - trying again later.");
    ...
    private void processPendingCommandsSynchronous(Account account) throws MessagingException {
        ...
        try {
            for (PendingCommand command : commands) {
                ...
                try {
                    ...
                    if (me.isPermanentFailure()) {
                        addErrorMessage(account, null, me);
                        System.out.println("Failure of command '" + command + "' was permanent, removing command from queue");
            ...
            addErrorMessage(account, null, me);
            System.out.println("Could not process command '" + processingCommand + "'");
            throw me;
        } finally {
            for (MessagingListener l : getListeners()) {
    ...
    private void processPendingAppend(PendingCommand command, Account account)
        ...
        try {
            ...
            if (!localMessage.getUid().startsWith(MailboxController.LOCAL_UID_PREFIX)) {
                remoteMessage = remoteFolder.getMessage(localMessage.getUid());
            }

            if (remoteMessage == null) {
                if (localMessage.isSet(Flag.X_REMOTE_COPY_STARTED)) {
                    System.out.println("Local message with uid " + localMessage.getUid() +
                            " has flag " + Flag.X_REMOTE_COPY_STARTED + " already set, checking for remote message with " +
                            " same message id");
                    String rUid = remoteFolder.getUidFromMessageId(localMessage);
                    if (rUid != null) {
                        System.out.println("Local message has flag " + Flag.X_REMOTE_COPY_STARTED + " already set, and there is a remote message with " +
                        ...
                        System.out.println("No remote message with message-id found, proceeding with append");
                    }
                }
        ...
        try {
            ...
            if (hasNewUids) {
                ...
                for (int i = 4; i < 4 + offset; i++) {
                    ...
                    if (!uid.startsWith(MailboxController.LOCAL_UID_PREFIX)) {
            ...
            if (!isCopy && destFolder.equals(account.getTrashFolderName())) {
                ...
                if (MailboxController.FOLDER_NONE.equals(destFolderName)) {
                    destFolderName = null;
                }
    ...
    private void processPendingMarkAllAsRead(PendingCommand command, Account account) throws MessagingException {
        ...
        try {
            ...
            System.out.println("Could not mark all server-side as read because store doesn't support operation");
        } finally {
            closeFolder(localFolder);
            closeFolder(remoteFolder);
        }
    ...
    public void addErrorMessage(Account account, String subject, Throwable t) {
        try {
            ...
            System.out.println("Could not save error message to " + account.getErrorFolderName());
        }
    }
    ...
    public void addErrorMessage(Account account, String subject, String body) {
        ...
        try {
            ...
            message.addSentDate(nowDate, true);
    ...
    private void setFlagSynchronous(final Account account, final List<Long> ids,
        ...
        try {
            ...
            System.out.println("Couldn't get LocalStore instance");
            return;
        }
        ...
        try {
            ...
            System.out.println("Couldn't set flags in local database");
        }
        ...
        try {
            ...
            System.out.println("Couldn't get folder name and UID of messages");
            return;
        }
        ...
        for (Entry<String, List<String>> entry : folderMap.entrySet()) {
            ...
            try {
                ...
                System.out.println("Couldn't get unread count for folder: " + folderName);
            }
    ...
    public void clearAllPending(final Account account) {
        try {
            System.out.println("Clearing pending commands!");
            LocalStore localStore = account.getLocalStore();
            localStore.removePendingCommands();
        } catch (MessagingException me) {
            System.out.println("Unable to clear pending command");
            addErrorMessage(account, null, me);
        }
    }
    ...
    public boolean loadMessageForViewRemoteSynchronous(final Account account, final String folder,
        ...
        try {
            ...
            if (uid.startsWith(MailboxController.LOCAL_UID_PREFIX)) {
                System.out.println("Message has local UID so cannot download fully.");
                // ASH move toast
    ...
    public void sendPendingMessages(MessagingListener listener) {
        ...
        Account account =  prefs.getCurrentAccount();
        sendPendingMessages(account, listener);
    }
    ...
    public boolean messagesPendingSend(final Account account) {
        ...
        try {
            ...
            System.out.println("Exception while checking for unsent messages");
        } finally {
            closeFolder(localFolder);
        }
        return false;
    ...
    public void sendPendingMessagesSynchronous(final Account account) {
        ...
        try {
            ...
            fp.add(FetchProfile.Item.ENVELOPE);
            fp.add(FetchProfile.Item.BODY);
            Transport transport = Transport.getInstance(MailboxController.app, account);
            for (LocalMessage message : localMessages) {
                ...
                try {
                    ...
                    if (count.incrementAndGet() > MailboxController.MAX_SEND_ATTEMPTS) {
                        System.out.println("Send count for message " + message.getUid() + " can't be delivered after " + MailboxController.MAX_SEND_ATTEMPTS + " attempts.  Giving up until the user restarts the device");
                    ...
                    localFolder.fetch(Collections.singletonList(message), fp, null);
                    try {
                        if (message.getHeader(MailboxController.IDENTITY_HEADER).length > 0) {
                            System.out.println("The user has set the Outbox and Drafts folder to the same thing. " +
            ...
            System.out.println("Failed to send pending messages because storage is not available - trying again later.");
            throw new UnavailableAccountException(e);
        } catch (Exception e) {
            for (MessagingListener l : getListeners()) {
        ...
        threadPool.execute(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    System.out.println("Count not get unread count for account " +
        ...
        Runnable unreadRunnable = new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    System.out.println( "Count not get unread count for account " + account.getDescription());
                }
                l.folderStatusChanged(account, folderName, unreadMessageCount);
            }
        };
    ...
    public boolean isMoveCapable(Message message) {
        return !message.getUid().startsWith(MailboxController.LOCAL_UID_PREFIX);
    }
    ...
    public boolean isMoveCapable(final Account account) {
        try {
            ...
            System.out.println("Exception while ascertaining move capability");
            return false;
        }
    }
    ...
    public boolean isCopyCapable(final Account account) {
        try {
            ...
            System.out.println("Exception while ascertaining copy capability");
            return false;
        }
    }
    ...
    private void moveOrCopyMessageSynchronous(final Account account, final String srcFolder,
        ...
        try {
            ...
            System.out.println("Failed to move/copy message because storage is not available - trying again later.");
            throw new UnavailableAccountException(e);
        } catch (MessagingException me) {
            addErrorMessage(account, null, me);
    ...
    public void deleteThreadsSynchronous(Account account, String folderName,
        ...
        try {
            ...
            System.out.println("Something went wrong while deleting threads");
        }
    }
    ...
    private void deleteMessagesSynchronous(final Account account, final String folder, final List<? extends Message> messages,
        ...
        try {
            ...
            if (folder.equals(account.getOutboxFolderName())) {
                ...
                System.out.println("Delete policy " + account.getDeletePolicy() + " prevents delete from server");
            }

            unsuppressMessages(account, messages);
        } catch (UnavailableStorageException e) {
            System.out.println("Failed to delete message because storage is not available - trying again later.");
            throw new UnavailableAccountException(e);
        } catch (MessagingException me) {
            addErrorMessage(account, null, me);
        ...
        putBackground("emptyTrash", listener, new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    System.out.println("Failed to empty trash because storage is not available - trying again later.");
                    throw new UnavailableAccountException(e);
                } catch (Exception e) {
                    System.out.println("emptyTrash failed");
                    addErrorMessage(account, null, e);
                } finally {
                    closeFolder(localFolder);
                }
                ...
                message.getUid(), new MessagingListener() {
                    ...
                    public void loadMessageForViewBodyAvailable(Account account, String folder, String uid,
                        ...
                        try {
                            ...
                            System.out.println("Unable to send email through alternate program");
                        }
                    }
                });
    ...
    public void checkMail(final Context context, final Account account,
        ...
        if (useManualWakeLock) {
            ...
            twakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "K9 MessageController.checkMail");
            twakeLock.setReferenceCounted(false);
            twakeLock.acquire(MailboxController.MANUAL_WAKE_LOCK_TIMEOUT);
        }
            ...
            public void run() {
                ...
                try {
                    ...
                    if (account != null) {
                        ...
                        accounts.add(prefs.getCurrentAccount());
                    }
                    for (final Account account : accounts) {
                    ...
                    System.out.println("Unable to synchronize mail");
                    addErrorMessage(account, null, e);
                }
    ...
    private void checkMailForAccount(final Context context, final Account account,
        ...
        try {
            ...
            System.out.println("Unable to synchronize account " + account.getName());
            addErrorMessage(account, null, e);
        } finally {
        ...
        putBackground("sync" + folder.getName(), null, new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            System.out.println("Exception while processing folder " +
        ...
        putBackground("compact:" + account.getDescription(), ml, new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    System.out.println("Failed to compact account because storage is not available - trying again later.");
                    throw new UnavailableAccountException(e);
                } catch (Exception e) {
                    System.out.println("Failed to compact account " + account.getDescription());
                }
            }
        });
    }
        ...
        putBackground("clear:" + account.getDescription(), ml, new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    System.out.println("Failed to clear account because storage is not available - trying again later.");
                    throw new UnavailableAccountException(e);
                } catch (Exception e) {
                    System.out.println("Failed to clear account " + account.getDescription());
                }
            }
        });
    }
        ...
        putBackground("recreate:" + account.getDescription(), ml, new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    System.out.println("Failed to recreate an account because storage is not available - trying again later.");
                    throw new UnavailableAccountException(e);
                } catch (Exception e) {
                    System.out.println("Failed to recreate account " + account.getDescription());
                }
            }
        });
    }
    ...
    public Message saveDraft(final Account account, final Message message, long existingDraftId, boolean saveRemotely) {
        ...
        try {
            ...
            localMessage = localFolder.getMessage(message.getUid());
            localMessage.setFlag(Flag.X_DOWNLOADED_FULL, true);
            localMessage.setFlag(Flag.DRAFT,true);
    ...
    public boolean setupPushing(final Account account) {
        try {
            ...
            System.out.println("Got exception while setting up pushing");
        }
        return false;
    }
    ...
    public void messagesArrived(final Account account, final Folder remoteFolder, final List<Message> messages, final boolean flagSyncOnly) {
            ...
            public void run() {
                ...
                try {
                    ...
                    try {
                        ...
                        System.out.println("Unable to set failed status on localFolder");
                    }
                    for (MessagingListener l : getListeners()) {
        ...
        try {
            ...
            System.out.println("Interrupted while awaiting latch release");
        }
    }
