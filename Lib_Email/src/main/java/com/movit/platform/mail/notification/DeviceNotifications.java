...
import static com.movit.platform.mail.notification.NotificationController.NOTIFICATION_LED_BLINK_SLOW;
import static com.movit.platform.mail.notification.NotificationController.platformSupportsExtendedNotifications;
...
class DeviceNotifications extends BaseNotifications {
    ...
    private void addDeleteAllAction(Builder builder, NotificationData notificationData) {
        if (MailboxController.getNotificationQuickDeleteBehaviour() != NotificationQuickDelete.ALWAYS) {
            return;
        }
    ...
    private boolean isPrivacyModeActive() {
        ...
        boolean privacyModeAlwaysEnabled = MailboxController.getNotificationHideSubject() == NotificationHideSubject.ALWAYS;
        boolean privacyModeEnabledWhenLocked = MailboxController.getNotificationHideSubject() == NotificationHideSubject.WHEN_LOCKED;
