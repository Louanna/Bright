...
class MigrationTo41 {
    ...
    public static void db41UpdateFolderMetadata(SQLiteDatabase db, MigrationsHelper migrationsHelper) {
        ...
        try {
            ...
            System.out.println("Exception while upgrading database to v41. folder classes may have vanished");
        } finally {
    ...
    private static void update41Metadata(SQLiteDatabase db, MigrationsHelper migrationsHelper, int id, String name) {
        ...
        try {
            ...
            System.out.println(" Throwing away an error while trying to upgrade folder metadata");
        }
