...
public class MessageProvider extends ContentProvider {
    ...
    protected class MessagesQueryHandler implements QueryHandler {
        ...
        protected MatrixCursor getMessages(final String[] projection) throws InterruptedException {
            ...
            final MessageController msgController = MessageController.getInstance(getContext());
    ...
    protected class UnreadQueryHandler implements QueryHandler {
        ...
        private Cursor getAccountUnread(int accountNumber) {
            ...
            Account account = Preferences.getPreferences(getContext()).getCurrentAccount();
    ...
    protected static class MonitoredCursor implements CrossProcessCursor {
        ...
        public void close() {
            if (mClosed.compareAndSet(false, true)) {
                mCursor.close();
                System.out.println("Cursor closed, null'ing & releasing semaphore");
                mCursor = null;
                mSemaphore.release();
            }
        }
    ...
    protected class ThrottlingQueryHandler implements QueryHandler {
        ...
        public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
            ...
            if (!(cursor instanceof CrossProcessCursor)) {
                System.out.println("Unsupported cursor, returning null: " + cursor);
                mSemaphore.release();
                return null;
            }
            ...
            mScheduledPool.schedule(new Runnable() {
                ...
                public void run() {
                    ...
                    if (monitored != null && !monitored.isClosed()) {
                        System.out.println("Forcibly closing remotely exposed cursor");
                        try {
                            monitored.close();
                        } catch (Exception e) {
                            System.out.println("Exception while forcibly closing cursor");
                        }
                    }
                }
            }, 30, TimeUnit.SECONDS);
    ...
    protected class MesssageInfoHolderRetrieverListener extends MessagingListener {
        ...
        public void searchStats(AccountStats stats) {
            try {
                ...
                System.out.println("Unable to return message list back to caller");
            }
        }
    }
    ...
    public boolean onCreate() {
        ...
        MailboxController.registerApplicationAware(new MailboxController.ApplicationAware() {
            @Override
            public void initializeComponent(final Application application) {
                MessageController.getInstance(application).addListener(new MessagingListener() {
                    @Override
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        if (myAccount == null) {
            System.out.println("Could not find account with id " + accountId);
        }
        ...
        if ((myAccount != null) && (msg != null)) {
            MessageController controller = MessageController.getInstance(getContext());
    ...
    public Cursor query(final Uri uri, final String[] projection, final String selection,
        ...
        try {
            ...
            System.out.println("Unable to execute query for URI: " + uri);
            return null;
        }
