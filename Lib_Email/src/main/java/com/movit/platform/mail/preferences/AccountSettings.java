...
import com.movit.platform.mail.bean.Account.MessageFormat;
import com.movit.platform.mail.bean.Account.QuoteStyle;
import com.movit.platform.mail.bean.Account.Searchable;
import com.movit.platform.mail.bean.Account.ShowPictures;
...
public class AccountSettings {
    ...
    static {
        ...
        s.put("displayCount", Settings.versions(
                new V(1, new IntegerResourceSetting(MailboxController.DEFAULT_VISIBLE_LIMIT,
    ...
    public static class IntegerResourceSetting extends PseudoEnumSetting<Integer> {
        ...
        public IntegerResourceSetting(int defaultValue, int resId) {
            ...
            String[] values = MailboxController.app.getResources().getStringArray(resId);
    ...
    public static class StorageProviderSetting extends SettingsDescription {
        ...
        public Object getDefaultValue() {
            return StorageManager.getInstance(MailboxController.app).getDefaultProviderId();
        }

        @Override
        public Object fromString(String value) {
            StorageManager storageManager = StorageManager.getInstance(MailboxController.app);
