...
import com.movit.platform.mail.crypto.DecryptedTempFileBody;
...
import com.movit.platform.mail.provider.K9FileProvider;
...
public class LocalMessageExtractor {
    ...
    public static MessageViewInfo decodeMessageForView(Context context,
        ...
        System.out.println("parts.length=" + parts.size());
        ...
        for (Part part : parts) {
            ...
            ViewableContainer viewable = extractTextAndAttachments(context, viewables,
                    attachments);
