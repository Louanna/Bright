...
//                MessageController controller = MessageController.getInstance(context);
...
//            } else {
//                Account realAccount = Preferences.getPreferences(context).createAccount(accountUuid);
//                if (realAccount != null) {
//                    account = realAccount;
//                    stats = realAccount.getStats(context);
//
//                    if (MailboxController.FOLDER_NONE.equals(realAccount.getAutoExpandFolderName())) {
