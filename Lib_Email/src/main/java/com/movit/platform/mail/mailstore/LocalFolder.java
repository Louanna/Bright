...
import com.movit.platform.mail.mailstore.LockableDatabase.DbCallback;
import com.movit.platform.mail.mailstore.LockableDatabase.WrappedException;
import com.movit.platform.mail.message.extractors.MessagePreviewCreator;
import com.movit.platform.mail.message.extractors.PreviewResult;
...
public class LocalFolder extends Folder<LocalMessage> implements Serializable {
                ...
                public Void doDbWork(final SQLiteDatabase db) throws WrappedException {
                    ...
                    try {
                        ...
                        if (cursor.moveToFirst() && !cursor.isNull(LocalStore.FOLDER_ID_INDEX)) {
                            ...
                            System.out.println("Creating folder " + getName() + " with existing id " + getId());
    ...
    public void refresh(String name, PreferencesHolder prefHolder) {
        ...
        try {
            ...
            System.out.println("Unable to load notifyMode for " + getName());
        }
        ...
        try {
           ...
           System.out.println("Unable to load pushMode for " + getName());
        }
                ...
                public Void doDbWork(final SQLiteDatabase db) throws WrappedException, UnavailableStorageException {
                    try {
                        ...
                        for (Message message : msgs) {
                            ...
                            String newUid = MailboxController.LOCAL_UID_PREFIX + UUID.randomUUID().toString();
    ...
    protected void saveMessage(SQLiteDatabase db, Message message, boolean copy, Map<String, String> uidMap)
        ...
        if (shouldCreateNewMessage) {
            String randomLocalUid = MailboxController.LOCAL_UID_PREFIX + UUID.randomUUID().toString();
    ...
    private void renameTemporaryFile(File file, String messagePartId) {
        ...
        if (!file.renameTo(destination)) {
            System.out.println("Couldn't rename temporary file " + file.getAbsolutePath() +
        ...
        localStore.database.execute(false, new DbCallback<Void>() {
            ...
            public Void doDbWork(final SQLiteDatabase db) throws WrappedException, UnavailableStorageException {
                ...
                try {
                    ...
                    System.out.println("Error writing message part");
                }
                ...
                public Void doDbWork(final SQLiteDatabase db) throws WrappedException,
                    ...
                    for (Message message : messages) {
                        try {
                            ...
                            System.out.println("Something went wrong while setting flag");
                        }
                    }
    ...
    private void deleteMessagePartsFromDisk(SQLiteDatabase db, long rootMessagePartId) {
        ...
        try {
            while (cursor.moveToNext()) {
                ...
                if (file.exists()) {
                    if (!file.delete()) {
                        System.out.println("Couldn't delete message part file: " + file.getAbsolutePath());
                    }
                }
            }
        } finally {
