...
import com.movit.platform.mail.preferences.Settings.InvalidSettingValueException;
import com.movit.platform.mail.preferences.Settings.SettingsDescription;
        ...
        for (Entry<String, TreeMap<Integer, SettingsDescription>> versionedSetting :
            ...
            if (valueString != null) {
                try {
                    ...
                    System.out.println("Global setting \"" + key  + "\" has invalid value \"" +
            ...
            if (versionedSetting != null) {
                ...
                if (setting != null) {
                    ...
                    try {
                        ...
                        System.out.println("Account setting \"" + keyPart + "\" (" +
            ...
            if (versionedSetting != null) {
                ...
                if (setting != null) {
                    ...
                    try {
                       ...
                       System.out.println("Identity setting \"" + identityKey +
            ...
            if (versionedSetting != null) {
                ...
                if (setting != null) {
                    ...
                    try {
                        ...
                        System.out.println("Folder setting \"" + folderKey +
                                "\" has invalid value \"" + valueString +
                                "\" in preference storage. This shouldn't happen!");
                    }
                }
