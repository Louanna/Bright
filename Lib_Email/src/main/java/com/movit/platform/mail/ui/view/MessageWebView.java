...
import com.movit.platform.mail.util.HtmlSanitizer;
...
public class MessageWebView extends RigidWebView {
    ...
    public void configure() {
        ...
        if (MailboxController.autofitWidth()) {
        ...
        webSettings.setTextZoom(MailboxController.getFontSizes().getMessageViewContentAsPercent());
    ...
    public void emulateShiftHeld() {
        try {
            ...
            System.out.println("Exception in emulateShiftHeld()");
        }
    }
