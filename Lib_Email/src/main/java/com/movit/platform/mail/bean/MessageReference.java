            ...
            if (account != null) {
                ...
                if (folder != null) {
                    ...
                    if (message != null) {
                        ...
                        System.out.println( "Could not restore message, uid " + uid + " is unknown.");
                    }
                } else {
                    System.out.println("Could not restore message, folder " + folderName + " is unknown.");
                }
            } else {
                System.out.println( "Could not restore message, account " + accountUuid + " is unknown.");
            }
        } catch (MessagingException e) {
            System.out.println( "Could not retrieve message for reference.");
        }
